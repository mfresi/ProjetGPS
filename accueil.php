        ...
        <div class="white container z-depth-3" style="min-height:50vh;">
            <div class="container" style="margin-top : 10%; padding-top : 5%; padding-bottom : 5%; margin-bottom : 10%;">
                <div class="center-align">
                    ...
                    <div class="container" style="padding-bottom : 50%; margin-bottom : 10%; margin-top : 5%; background-image: url('images/geoboat.png');background-position: center center;background-size: cover;">
                </div>
                <p>Geoboat est une entreprise côté en bateau de compète c'est trop le feu starfoufou.</p>
